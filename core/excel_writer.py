...
def _build_history_sheet(
    ...
    for (
        ...
        # HAFTA SONUNDA TARİH HÜCRESİ SARI
        if (
            run_dt
            and run_dt.weekday()
            in (
...
def _build_summary_sheet(
    ...
    # ========================================================
    # AYLIK GRAFİK YARDIMCI VERİSİ
    # ========================================================

    monthly_helper_row = 400
...
def build_excel(
    ...
    # yalnızca İLK çalışma kullanılır.
    daily_history = (
        _daily_history(
            history
        )
